...
13:null
1b:I[622,[],"IconMark"]
15:{"metadata":[["$","title","0",{"children":"Whitepaper — Busbar Calculation Formulas & Methodology | Busbar Calculator"}],["$","meta","1",{"name":"description","content":"How the Busbar Calculator works under the hood: busbar weight and cost formulas, ampacity methodology, live COMEX/LME price pipeline, kerf & punch-out waste math, architecture and technology stack."}],["$","link","2",{"rel":"author","href":"https://calculator.payapress.com"}],["$","meta","3",{"name":"author","content":"Busbar Calculator"}],["$","link","4",{"rel":"manifest","href":"/manifest.json","crossOrigin":"$undefined"}],["$","meta","5",{"name":"keywords","content":"busbar calculation formula,busbar weight formula,busbar ampacity,copper density calculation,busbar engineering methodology"}],["$","meta","6",{"name":"creator","content":"Busbar Calculator"}],["$","meta","7",{"name":"publisher","content":"Busbar Calculator"}],["$","meta","8",{"name":"robots","content":"index, follow"}],["$","meta","9",{"name":"googlebot","content":"index, follow, max-video-preview:-1, max-image-preview:large, max-snippet:-1"}],["$","link","10",{"rel":"canonical","href":"https://calculator.payapress.com/whitepaper"}],["$","meta","11",{"name":"mobile-web-app-capable","content":"yes"}],["$","meta","12",{"name":"apple-mobile-web-app-title","content":"Busbar Calc"}],["$","meta","13",{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"}],["$","meta","14",{"property":"og:title","content":"Busbar Calculation Formulas & Methodology — Whitepaper"}],["$","meta","15",{"property":"og:description","content":"Weight, cost and waste formulas, ampacity methodology and the live price pipeline behind the Busbar Calculator."}],["$","meta","16",{"property":"og:url","content":"https://calculator.payapress.com/whitepaper"}],["$","meta","17",{"property":"og:type","content":"article"}],["$","meta","18",{"name":"twitter:card","content":"summary_large_image"}],["$","meta","19",{"name":"twitter:title","content":"Busbar Calculator — Copper & Aluminum Busbar Cost Calculator"}],["$","meta","20",{"name":"twitter:description","content":"Live COMEX copper & aluminum pricing · 17 currencies · IEC standard cross-sections."}],["$","link","21",{"rel":"shortcut icon","href":"/icon"}],["$","link","22",{"rel":"icon","href":"/icon","type":"image/png","sizes":"512x512"}],["$","link","23",{"rel":"icon","href":"/favicon.svg","type":"image/svg+xml"}],["$","link","24",{"rel":"apple-touch-icon","href":"/apple-icon","sizes":"180x180","type":"image/png"}],["$","link","25",{"rel":"mask-icon","href":"/favicon.svg","color":"#cd7f32"}],["$","$L1b","26",{}]],"error":null,"digest":"$undefined"}
1a:"$15:metadata"
