...
9:["$","$1","c",{"children":[["$","$Ld",null,{"initialSheet":"signup"}],null,["$","$Le",null,{"children":["$Lf",["$","$L10",null,{"promise":"$@11"}]]}]]}]
