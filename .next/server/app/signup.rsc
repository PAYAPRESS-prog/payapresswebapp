...
a:["$","$1","c",{"children":[["$","$Le",null,{"initialSheet":"signup"}],null,["$","$Lf",null,{"children":["$L10",["$","$L11",null,{"promise":"$@12"}]]}]]}]
