...
d:["$","$1","c",{"children":[["$","$L11",null,{"initialSheet":"signup"}],null,["$","$L12",null,{"children":["$L13",["$","$L14",null,{"promise":"$@15"}]]}]]}]
