(()=>{var a={};a.id=178,a.ids=[178],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4274:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>E,patchFetch:()=>D,routeModule:()=>z,serverHooks:()=>C,workAsyncStorage:()=>A,workUnitAsyncStorage:()=>B});var d={};c.r(d),c.d(d,{GET:()=>y,dynamic:()=>x,runtime:()=>w});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641),v=c(81410);let w="nodejs",x="force-dynamic";async function y(a){let{searchParams:b}=new URL(a.url),c=b.get("to"),d={configured:(0,v.nf)(),SMTP_HOST:process.env.SMTP_HOST??"(not set)",SMTP_PORT:process.env.SMTP_PORT??"(not set)",SMTP_USER:process.env.SMTP_USER??"(not set)",SMTP_PASS:process.env.SMTP_PASS?"(set)":"(not set)"};if(!c)return u.NextResponse.json({config:d,usage:"Add ?to=your@email.com to send a test email"});try{return await (0,v.sj)({to:c,subject:"Delivery Test — Busbar Calculator",html:`<div style="font-family:Arial,sans-serif;padding:20px">
