(()=>{var a={};a.id=8093,a.ids=[8093],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},3295:a=>{"use strict";a.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},4573:a=>{"use strict";a.exports=require("node:buffer")},7749:(a,b,c)=>{"use strict";c.d(b,{E:()=>e,T:()=>f});let d=new Map;function e(a,b,c){let e=Date.now();if(d.size>=5e4&&!d.has(a)){for(let[a,b]of d)e>b.resetAt&&d.delete(a);if(d.size>=5e4)return!0}let f=d.get(a);return!f||e>f.resetAt?(d.set(a,{count:1,resetAt:e+c}),!0):(f.count++,f.count<=b)}function f(a){let b=a.headers.get("x-real-ip"),c=a.headers.get("x-forwarded-for")?.split(",")[0]?.trim();return(b||c||"unknown").slice(0,45)||"unknown"}setInterval(()=>{let a=Date.now();for(let[b,c]of d)a>c.resetAt&&d.delete(b)},3e5).unref()},10846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},14985:a=>{"use strict";a.exports=require("dns")},19121:a=>{"use strict";a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},19771:a=>{"use strict";a.exports=require("process")},21820:a=>{"use strict";a.exports=require("os")},26396:(a,b,c)=>{"use strict";c.d(b,{Gs:()=>g,Ln:()=>n,Xo:()=>l,at:()=>j,bJ:()=>k,iR:()=>q,kg:()=>i,lC:()=>h,r7:()=>m});var d=c(35552);let e=!1;async function f(){if(e)return;let a=(0,d.d)();await a.query(`
  ...
  `);let[b]=await a.query(`SELECT COLUMN_NAME FROM information_schema.COLUMNS
     WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = 'users'`),c=new Set(b.map(a=>String(a.COLUMN_NAME).toLowerCase()));for(let[b,d]of[["first_name","VARCHAR(100) NULL"],["last_name","VARCHAR(100) NULL"],["company","VARCHAR(150) NULL"],["phone","VARCHAR(30)  NULL"],["google_id","VARCHAR(64)  NULL"]])c.has(b)||await a.query(`ALTER TABLE users ADD COLUMN ${b} ${d}`).catch(a=>{console.error(`[users] failed to add column ${b}:`,a)});await a.query("ALTER TABLE users MODIFY password_hash VARCHAR(255) NULL").catch(()=>{}),c.has("google_id")||await a.query("CREATE UNIQUE INDEX uniq_google_id ON users (google_id)").catch(()=>{}),e=!0}async function g(a){await f();let b=(0,d.d)(),[c]=await b.query("SELECT id, email, password_hash, opt_in, google_id FROM users WHERE email = ? LIMIT 1",[a.toLowerCase()]);return c[0]??null}async function h(a){await f();let b=(0,d.d)(),[c]=await b.query("SELECT id, email, password_hash, opt_in, first_name, last_name, company, phone FROM users WHERE id = ? LIMIT 1",[a]);return c[0]??null}async function i(a,b,c){await f();let e=(0,d.d)(),[g]=await e.query("INSERT INTO users (email, password_hash, opt_in) VALUES (?, ?, ?)",[a.toLowerCase(),b,+!!c]);return g.insertId}async function j(a){await f();let b=(0,d.d)(),[c]=await b.query("SELECT id, email, password_hash, opt_in, google_id FROM users WHERE google_id = ? LIMIT 1",[a]);return c[0]??null}async function k(a,b,c,e){await f();let g=(0,d.d)(),[h]=await g.query(`INSERT INTO users (email, password_hash, google_id, first_name, last_name, opt_in)
     VALUES (?, NULL, ?, ?, ?, 0)`,[a.toLowerCase(),b,c??null,e??null]);return h.insertId}async function l(a,b){await f();let c=(0,d.d)();await c.query("UPDATE users SET google_id = ? WHERE id = ?",[b,a])}async function m(a,b){await f();let c=(0,d.d)(),e=[],g=[];for(let[a,c]of Object.entries(b))e.push(`${a} = ?`),g.push(c??null);0!==e.length&&(g.push(a),await c.query(`UPDATE users SET ${e.join(", ")} WHERE id = ?`,g))}async function n(a,b){await f();let c=(0,d.d)();await c.query("UPDATE users SET password_hash = ? WHERE id = ?",[b,a])}let o=!1;async function p(){if(o)return;let a=(0,d.d)();await a.query(`
  ...
  `),o=!0}async function q(a,b){await p();let c=(0,d.d)(),[e]=await c.query(`SELECT id, email, first_name, last_name, company, phone, opt_in, created_at
...
https://calculator.payapress.com`}}},81630:a=>{"use strict";a.exports=require("http")},86439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},91645:a=>{"use strict";a.exports=require("net")},94735:a=>{"use strict";a.exports=require("events")},96487:()=>{}};var b=require("../../../../../webpack-runtime.js");b.C(a);var c=b.X(0,[1331,1692,9382,466,6386,5112],()=>b(b.s=53780));module.exports=c})();