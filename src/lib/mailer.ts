...
export async function sendMail(opts: MailOptions): Promise<void> {
  ...
  if (isBulk) {
    // Bulk / newsletter — signal to inbox providers this is mass mail.
    extraHeaders['Precedence']             = 'bulk';
    extraHeaders['List-Unsubscribe-Post']  = 'List-Unsubscribe=One-Click';
  } else {
    // Transactional — triggered by the user's own action; must NOT carry
    // Precedence:bulk or Gmail will route it directly to Spam/Promotions.
